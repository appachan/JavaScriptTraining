...
describe('ステージ3（意図した通りに DOM 要素の構造を変更できるようになる）', function() {
  describe('DOMインターフェース編', function() {
    ...
    it('3 番の要素の左右の幽霊要素をすべて除去する', function() {
      ...
      var ghosts1 = document.querySelector('.mediumseagreen-ghosts:nth-child(1)');
      var ghosts2 = document.querySelector('.mediumseagreen-ghosts:nth-child(2)');
      element.removeChild(ghosts1);
      element.removeChild(ghosts2);
    ...
    it('5 番の青色の要素の最初に要素を追加する', function() {
      ...
      //element.parentNode.insertBefore(elementToAdd, element);//blockquoteの前に挿入される
      //element.appendChild(elementToAdd);
      element.insertBefore(elementToAdd, null);//上と同じ
  ...
  describe('jQuery 編', function() {
    ...
    it('10 番の青色の要素の最初に要素を追加する', function() {
      ...
      // 上の $elementToAdd を追加するコードをここに記述してください。
      var $element = $('p');
      $elementToAdd.prependTo($element);
